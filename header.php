  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="index55.php">Home</a></li>
         <?php
          ...
          if(!isset($_SESSION['uid'])){
            ...
            <li><a class="nav-link scrollto" href="theatherall.php">Theather</a></li>
            ...
            $type = $_SESSION['type'];
             if($type == 2){
              ...
              <li class="nav-item">
              <a class="nav-link" href="https://wa.me/9562307843"><i class="bi bi-chat-left-dots-fill"></i></a>
            </li>
              ';
             }
          }
