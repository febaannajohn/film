          ...
          if($data=mysqli_fetch_array($res))
           {
             ...
             <a href="checkout.php?id=<?php echo $data["theaterid"];?>"><div class="text-center"><button type="submit" class="btn btn-primary" name="ticketbook">Ticket Book</button></div></a>
          
          <!-- <a href="booking.php?pid=<?php echo $data["theaterid"];?>" role="button">Continue to checkout</a> -->
                     
        
            <!-- <a href="checkout.php" class="btn btn-success">checkout Payment</a> -->
